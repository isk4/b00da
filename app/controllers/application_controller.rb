class ApplicationController < ActionController::API
    ...
    def spread
        ...
        code = spread[:code]
        spread.delete(:code) if spread[:message] != "error"
    ...
    def all_spreads
        ...
        code = spreads[:code]
        spreads.delete(:code) if spreads[:message] != "error"
    ...
    def save_spread_alert
        ...
        code = alert[:code]
        alert.delete(:code) if alert[:message] != "error"
    ...
    def poll_spread_alert
        ...
        code = sprd_comp[:code]
        sprd_comp.delete(:code) if sprd_comp[:message] != "error"
